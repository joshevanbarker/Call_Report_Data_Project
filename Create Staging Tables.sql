...
-- Import the MDRM descriptions
DROP TABLE IF EXISTS mdrm_descriptions

CREATE TABLE mdrm_descriptions(
mdrm CHAR(8) PRIMARY KEY,
description VARCHAR(36)
);

COPY mdrm_descriptions FROM 'FFIEC CDR Call Data/mdrm_definitions.csv' (FORMAT CSV, HEADER);